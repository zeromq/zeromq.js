vcpkg_from_github(
    ...
    PATCHES
        ...
        pkgconfig.diff
        rename-sha1.diff
        wasm-pipe-signaler.patch
        wasm-async-poller.patch
)
...
# This overlay is wired only for the Emscripten target. Emscripten exposes
# epoll headers, but its standalone implementation returns ENOSYS. WasmFS
# provides the poll path used by ZeroMQ instead.
list(APPEND PLATFORM_OPTIONS "-DPOLLER=poll")
